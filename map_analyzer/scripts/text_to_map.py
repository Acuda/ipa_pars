...
class TextToPicture:
    def __init__(self):
        f = open("/home/rmbce/git/catkin_ws/src/ipa_pars/map_analyzer/knowledge/static-knowledge-base.yaml", 'r')
        yamlfile = load(f)
        f.close()
        self.location_data = yamlfile["location-data"]
        path_to_img = "/home/rmbce/git/catkin_ws/src/ipa_pars/map_analyzer/maps/logimg6.png"
    ...
    def putTextOnPic(self):
        ...
        try:
            ...
            cv2.imwrite("/home/rmbce/git/catkin_ws/src/ipa_pars/map_analyzer/maps/logwithtext3.png", self.input_img, [cv2.IMWRITE_PNG_COMPRESSION, 10])
